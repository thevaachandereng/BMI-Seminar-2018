...
\begin{figure}
     \includegraphics[width=0.60\linewidth]{Lags.png}
      \caption{An example of the effects of applying different lags to genes 1 and 2.  Gene 1 and 2 are not lagged in top row. Gene 1 with lag -1, gene 2 with no lags in middle row. Gene 1 with lag -1 and gene 2 with lag 1 in the bottom row.}
       \label{fig:lags}
    \end{figure}
